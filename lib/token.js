...
exports.Range = Range;
exports.CountComposition = CountComposition;
exports.GenConstantSumToken = GenConstantSumToken;
 ...
 */
var generateToken = function generateToken(option) {
...
CountComposition.prototype.narrowRange = function (value) {
  ...
  var random1 = narrowedRange1.random(); // console.log('narrowed',narrowedRange1, new Range(range2min, range2max))
